...
#End Region
  ...
  Private Sub btnDisplay_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDisplay.Click
    ...
    Dim blob As OracleLob = dataReader.GetOracleLob(0)

    '// we are done with the reader now, so we can close it
    dataReader.Close()

    '// create a memory stream from the blob
    Dim bf(blob.Length) As Byte
    blob.Read(bf, 0, Convert.ToInt32(blob.Length))
    Dim ms As MemoryStream = New MemoryStream(bf)
